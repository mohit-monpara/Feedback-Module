...
<p>
<?php
echo "Hello ".AuthComponent::user('fullname');
echo '<br>';
echo "We would love to know more about you, please fill in the given form!";
?>
</p>
<div class="row">
          <div class="col-lg-6">
...
<?php echo $this->Form->create('CompanyMaster', array(
	...
	<fieldset>
		<legend><?php echo __('Tell Us About You'); ?></legend>
