...
<h2><?php echo __('Event Feedback Form '); ?></h2>
<div class="row">
...
<table cellpadding="0" cellspacing="0" class="table table-striped">
	...
	<td>
			 <?php echo h($feedbackAnswer['FeedbackEventQuestion']['text']); ?>&nbsp;
	</td>
	<td class="actions">
		<?php
    	echo $this->Form->input($i.".feedback_event_question_id",['type' => 'hidden','value' => $feedbackAnswer['FeedbackEventQuestion']['id']]);
